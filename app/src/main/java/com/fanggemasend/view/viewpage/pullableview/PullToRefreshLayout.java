...
//                refreshStateTextView.setText(R.string.refreshing);
    ...
    private void initView() {
        // 初始化下拉布局
        //获取头布局图片组件
        ivRider = (ImageView) refreshView.findViewById(R.id.iv_rider);
        ivSun = (ImageView) refreshView.findViewById(R.id.ivsun);
        ivWheel1 = (ImageView) refreshView.findViewById(R.id.wheel1);
        ivWheel2 = (ImageView) refreshView.findViewById(R.id.wheel2);
        ivBack1 = (ImageView) refreshView.findViewById(R.id.iv_back1);
        ivBack2 = (ImageView) refreshView.findViewById(R.id.iv_back2);
